  ...
  return (
    <main className="relative w-full lg:h-screen lg:overflow-hidden p-0 sm:p-5">
      <div className="w-full h-full rounded-2xl sm:border flex flex-wrap justify-between lg:divide-x">
        <div className="relative w-full lg:w-2/5 lg:min-h-0 p-2 md:p-8 pb-16 lg:pb-20 lg:overflow-y-auto scroll-smooth">
        ...
        <div id="tab-section" className="relative w-full lg:min-h-0 lg:w-3/5 p-2 md:p-8 pb-16 lg:pb-20 lg:overflow-y-auto scroll-smooth">
