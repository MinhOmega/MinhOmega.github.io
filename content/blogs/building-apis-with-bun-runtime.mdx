---
title: "Building APIs with Bun Runtime"
date: "2024-03-10"
description: "Bun for APIs: built-in HTTP server, SQLite, file I/O, and performance benchmarks."
tags: ["Bun", "Runtime", "API", "Backend"]
published: true
author: "MinhVo"
---
