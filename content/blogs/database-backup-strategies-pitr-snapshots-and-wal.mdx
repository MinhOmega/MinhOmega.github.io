...
Storage costs grow with backup retention. Optimize costs without sacrificing recovery capability:

| Strategy | Savings | Trade-off |
|----------|---------|-----------|
| Compress WAL archives | 60-80% | Slightly slower recovery |
| Tiered storage (S3 → Glacier) | 70-90% | Slower retrieval for old backups |
...
6. **Encrypt backups** — Protect sensitive data at rest and in transit
7. **Optimize costs** — Use tiered storage and compression to manage growing backup costs
