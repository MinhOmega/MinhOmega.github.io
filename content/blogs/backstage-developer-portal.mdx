...
date: "2020-08-20"
description: "Build a developer portal with Backstage for service catalog, documentation, and scaffolding."
tags: ["backstage", "developer-portal", "service-catalog", "spotify"]
published: true
author: "MinhVo"
---
## Introduction

DevOps practices have fundamentally changed how we build, deploy, and operate software systems. Backstage Developer Portal is a crucial capability for teams pursuing continuous delivery and operational excellence. This guide covers the tools, workflows, and cultural practices that make modern DevOps effective.
...
Kubernetes has become the standard platform for container orchestration in backstage developer portal environments. Understanding its architecture — pods, services, deployments, and operators — is essential for modern platform engineering.
...
A comprehensive observability stack is essential for operating backstage developer portal systems at scale. The combination of metrics, logs, and traces provides full visibility into system behavior.
...
Security must be integrated into every stage of the backstage developer portal pipeline rather than treated as a separate gate. Shifting security left catches vulnerabilities earlier when they're cheaper to fix.
